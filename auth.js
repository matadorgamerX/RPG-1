document.addEventListener('DOMContentLoaded', function() {
    // This ensures that firebase.initializeApp() from firebase-config.js has run first.
    ...
    auth.onAuthStateChanged(function(user) {
        ...
        if (user) {
            ...
            // This function is defined in items.js and will only run on that page.
...
/**
 * Signs the user in with Google. This function is global so it can be called by onclick attributes.
 */
...
/**
 * Signs the user out. This function is global so it can be called by onclick attributes.
 */
function signOut() {
